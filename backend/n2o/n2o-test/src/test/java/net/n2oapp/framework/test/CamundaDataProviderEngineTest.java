...
class CamundaDataProviderEngineTest {
    ...
    void getCountTasksTest() {
        ...
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.COUNT_TASKS);
    ...
    void findTasksTest() {
        ...
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.FIND_TASKS);
    ...
    void getTaskTest() {
        ...
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.GET_TASK);
    ...
    void setTaskVariablesTest() {
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.SET_TASK_VARIABLES);
    ...
    void completeTaskVariablesTest() {
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.COMPLETE_TASK);
    ...
    void startProcessTest() {
        ...
        invocation.setOperation(N2oCamundaDataProvider.OperationEnum.START_PROCESS);
