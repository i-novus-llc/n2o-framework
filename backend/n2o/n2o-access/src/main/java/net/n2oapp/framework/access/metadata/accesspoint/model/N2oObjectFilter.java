...
public class N2oObjectFilter extends N2oPreFilter {
    ...
    public N2oObjectFilter(String fieldId, FilterTypeEnum type, String id) {
        super(fieldId, type);
        this.id = id;
    }

    public N2oObjectFilter(String fieldId, String value, FilterTypeEnum type, String id) {
        super(fieldId, value, type);
        this.id = id;
    }

    public N2oObjectFilter(String fieldId, String[] values, FilterTypeEnum type, String id) {
