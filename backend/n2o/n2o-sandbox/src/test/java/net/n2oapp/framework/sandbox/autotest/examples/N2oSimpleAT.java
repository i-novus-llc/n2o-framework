...
public class N2oSimpleAT extends AutoTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        builder.sources(new CompileInfo("net/n2oapp/framework/sandbox/server/autotest/simple/index.page.xml"),
                new CompileInfo("net/n2oapp/framework/sandbox/server/autotest/simple/test.application.xml"));
    }
