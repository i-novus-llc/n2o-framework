...
//@SpringBootTest(properties = {"server.servlet.context-path=/", "n2o.engine.test.classpath=/examples/crud_sql/"},FIXME
//        classes = AutoTestApplication.class,
//        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
//@ContextConfiguration(classes = {CasesConfiguration.class})
//@EnableJpaRepositories(basePackageClasses = {net.n2oapp.framework.sandbox.server.cases.cars.CarRepository.class,
//        net.n2oapp.framework.sandbox.server.cases.persons.PersonRepository.class})
//@EntityScan(basePackages = {"net.n2oapp.framework.sandbox.server.cases.cars", "net.n2oapp.framework.sandbox.server.cases.persons"})
...
public class CrudRestAT extends AutoTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        builder.sources(new CompileInfo("net/n2oapp/framework/config/default/default.application.xml"),
                new CompileInfo("/examples/crud_rest/index.page.xml"),
