...
public enum DomainEnum {
    ...
    DomainEnum(String name, Class<?> type) {
        this.name = name;
        this.type = type;
    }

    DomainEnum(String name, Class<?> type, String jsFormat) {
        this.name = name;
        this.type = type;
    ...
    public static DomainEnum getByName(String name) {
    ...
    public static DomainEnum getByClass(Class<?> clazz) {
        for (DomainEnum domain : values()) {
