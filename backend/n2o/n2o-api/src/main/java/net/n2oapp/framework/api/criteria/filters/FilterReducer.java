...
import net.n2oapp.framework.api.criteria.filters.rule.*;
import net.n2oapp.framework.api.criteria.filters.rule.base.Rule;
import net.n2oapp.framework.api.criteria.filters.rule.like.*;
import net.n2oapp.framework.api.criteria.filters.rule.or.*;
...
public class FilterReducer {
    ...
    public static Result reduce(Filter left, Filter right) {
        ...
        if (rule == null)
            res.setType(Result.TypeEnum.NOT_MERGEABLE);
        else {
