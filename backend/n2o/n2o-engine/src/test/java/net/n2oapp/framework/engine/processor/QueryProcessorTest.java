...
class QueryProcessorTest {
    ...
    void setUp() {
        ...
        N2oCriteriaConstructor defaultConstructor = new N2oCriteriaConstructor(false);
        queryProcessor.setCriteriaConstructorFactory(new CriteriaConstructorFactory(List.of(defaultConstructor)));
