...
import net.n2oapp.framework.autotest.impl.component.field.*;
import net.n2oapp.framework.autotest.impl.component.header.N2oStandardTableHeader;
import net.n2oapp.framework.autotest.impl.component.page.N2oLeftRightPage;
import net.n2oapp.framework.autotest.impl.component.page.N2oModal;
...
import net.n2oapp.framework.autotest.impl.component.widget.N2oTableWidget;
...
public class N2oComponentLibrary implements ComponentLibrary {
    ...
    public List<Class<? extends Component>> components() {
        return Arrays.asList(N2oLeftRightPage.class, N2oSimpleRegion.class, N2oTableWidget.class,
                N2oStandardField.class, N2oCheckBox.class, N2oStandardButton.class, N2oStandardTableHeader.class,
                N2oInputControl.class, N2oTextCell.class, N2oDateInterval.class, N2oSimplePage.class, N2oFormWidget.class,
