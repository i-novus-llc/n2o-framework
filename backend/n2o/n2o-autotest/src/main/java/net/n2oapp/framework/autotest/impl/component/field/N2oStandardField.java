...
public class N2oStandardField extends N2oField implements StandardField {
    ...
    public <T extends Control> T control(Class<T> componentClass) {
        return N2oSelenide.component(element().$(".form-control, .n2o-input, .n2o-date-picker, .n2o-radio-container, .n2o-checkbox-group, .n2o-file-uploader-control"), componentClass);
    }
