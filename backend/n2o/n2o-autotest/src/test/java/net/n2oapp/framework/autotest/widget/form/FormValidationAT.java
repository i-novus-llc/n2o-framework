...
class FormValidationAT extends AutoTestBase {
    ...
    void formValidationTest() {
        ...
        form1Field.shouldHaveValidationMessage(Condition.text(REQUIRED_VALIDATION_MESSAGE));
        page.alerts(Alert.PlaceEnum.TOP).shouldBeEmpty();

        form1Control.click();
        form1Control.setValue("value1");
        validateFormBtn.click();
        form1Field.shouldHaveValidationMessage(Condition.empty);
        page.alerts(Alert.PlaceEnum.TOP).shouldHaveSize(1);
