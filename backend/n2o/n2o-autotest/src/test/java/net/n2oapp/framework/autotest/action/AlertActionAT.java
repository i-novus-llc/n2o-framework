...
class AlertActionAT extends AutoTestBase {
    ...
    void testAlertAction() {
        ...
        alert = page.alerts(Alert.PlaceEnum.TOP_RIGHT).alert(0);
        ...
        alert = page.alerts(Alert.PlaceEnum.BOTTOM_RIGHT).alert(0);
        ...
        alert = page.alerts(Alert.PlaceEnum.BOTTOM_LEFT).alert(0);
        alert.shouldExists();
