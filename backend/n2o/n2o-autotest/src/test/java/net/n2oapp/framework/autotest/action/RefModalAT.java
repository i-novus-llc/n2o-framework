...
class RefModalAT extends AutoTestBase {
    ...
    void refParentModalTest() {
        ...
        cityInputModal.click();
        cityInputModal.setValue("Москва");
        ...
        streetInputModal.click();
        streetInputModal.setValue("Ленина");
        ...
        modalPage.toolbar().bottomRight().button(SAVE_BUTTON_LABEL).click();
