...
public class SelectAT extends AutoTestBase {
    ...
    public void testReadFromQuery() {
        ...
        input.shouldHaveOptionWithDescription("name1", "desc1");
        input.shouldHaveOptionWithDescription("name3", "desc3");
        input.select(1);
        ...
        input2.shouldHaveOptionWithDescription("name1", "desc1");
        input2.shouldHaveOptionWithDescription("name3", "desc3");
