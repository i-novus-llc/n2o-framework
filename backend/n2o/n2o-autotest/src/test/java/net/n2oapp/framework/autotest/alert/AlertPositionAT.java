...
class AlertPositionAT extends AutoTestBase {
    ...
    void alertTest() {
        ...
        alert = page.alerts(Alert.PlaceEnum.BOTTOM).alert(0);
        ...
        Alert modalAlert = page.alerts(Alert.PlaceEnum.TOP).alert(0);
        modalAlert.shouldHaveText(SUCCESS_ALERT_MESSAGE);
