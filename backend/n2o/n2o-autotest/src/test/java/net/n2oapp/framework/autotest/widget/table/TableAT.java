...
class TableAT extends AutoTestBase {
    ...
    void testOverlay() {
        ...
        button.shouldExists();
        button.click();
        page.alerts(Alert.PlaceEnum.TOP_LEFT).alert(0).shouldHaveTitle("Уведомление по кнопке");
        ...
        page.alerts(Alert.PlaceEnum.TOP_RIGHT).alert(0).shouldHaveTitle("Уведомление по menu-item");
