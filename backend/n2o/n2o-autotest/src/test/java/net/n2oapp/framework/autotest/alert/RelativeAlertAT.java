 ...
 */
@SpringBootTest(properties = {"n2o.api.message.position=relative", "n2o.api.message.placement=top"},
        classes = AutoTestApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class RelativeAlertAT extends AutoTestBase {
