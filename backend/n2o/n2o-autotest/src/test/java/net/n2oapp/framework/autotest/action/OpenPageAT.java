...
public class OpenPageAT extends AutoTestBase {
    ...
    public void testTargetNewWindow() {
        setJsonPath("net/n2oapp/framework/autotest/action/open_page/target_window");
        builder.sources(
                new CompileInfo("net/n2oapp/framework/autotest/action/open_page/target_window/index.page.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/action/open_page/target_window/page.page.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/action/open_page/target_window/test.query.xml"));
