 ...
 */
class ColumnAccessAT extends AutoTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        setResourcePath("net/n2oapp/framework/autotest/access/attributes/column");
        builder.sources(
                new CompileInfo("net/n2oapp/framework/autotest/access/attributes/column/index.page.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/access/attributes/column/test.query.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/access/attributes/column/default.access.xml"));
    }
    ...
    void testAdminAccess() {
        ...
        header.shouldExists();
        header.shouldHaveTitle("Колонка видима с ролью admin");

        header = headers.header(2);
        header.shouldExists();
        header.shouldHaveTitle("Колонка видима с правом edit");

        headers.header(3).shouldHaveTitle("Колонка доступна с правом edit (toolbar)");
        headers.header(4).shouldHaveTitle("Колонка доступна с правом edit (input-text)");
        headers.header(5).shouldHaveTitle("Колонка доступна с правом edit (input-select)");
        headers.header(6).shouldHaveTitle("Колонка доступна с правом edit (date-time)");
        headers.header(7).shouldHaveTitle("Колонка доступна с правом edit (text-area)");
