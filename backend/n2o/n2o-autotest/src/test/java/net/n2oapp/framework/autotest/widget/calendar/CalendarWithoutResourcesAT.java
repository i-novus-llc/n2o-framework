...
class CalendarWithoutResourcesAT extends AutoTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        setResourcePath("net/n2oapp/framework/autotest/widget/calendar/without_resources");
        builder.sources(
                ...
                new CompileInfo("net/n2oapp/framework/autotest/widget/calendar/without_resources/test.object.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/widget/calendar/without_resources/createEvent.page.xml"),
                new CompileInfo("net/n2oapp/framework/autotest/widget/calendar/without_resources/selectEvent.page.xml"));
    }
    ...
    void testCalendarDayView() {
        ...
        // проверка хэдеров
        CalendarDayViewHeader header = dayView.header(CalendarDayViewHeader.class);
        ...
        CalendarEvent allDayEvent = header.allDayEvent("All day event");
    ...
    void testCalendarWeekView() {
        ...
        // проверка хэдеров
        CalendarWeekViewHeader header = weekView.header(CalendarWeekViewHeader.class);
