...
public class ImageCellAT extends AutoTestBase {
    ...
    public void imageCellWithStatusTest() {
        ...
        ImageCell cell = rows.row(0).cell(0, ImageCell.class);
        cell.shouldExists();
        cell.shouldHaveStatus(N2oImageStatusElement.Place.topRight, "Статус1");
        cell.statusShouldHaveIcon(N2oImageStatusElement.Place.topRight, ".fa.fa-plus");

        cell = rows.row(1).cell(0, ImageCell.class);
        cell.shouldHaveStatus(N2oImageStatusElement.Place.topRight, "Статус2");
    }
}
