...
public class AreaChartIOv5 extends StandardChartIOv5<N2oAreaChart> {
    ...
    public void io(Element e, N2oAreaChart c, IOProcessor p) {
        super.io(e, c, p);
        p.children(e, null, "area", c::getItems, c::setItems, N2oAreaChartItem.class, this::areaChartIO);
    }

    private void areaChartIO(Element e, N2oAreaChartItem i, IOProcessor p) {
        item(e, i, p);
        p.attributeEnum(e, "line-type", i::getLineType, i::setLineType, ChartLineTypeEnum.class);
