...
public class HtmlWidgetCompiler extends BaseWidgetCompiler<HtmlWidget, N2oHtmlWidget> {
    ...
    public HtmlWidget compile(N2oHtmlWidget source, CompileContext<?, ?> context, CompileProcessor p) {
        ...
        N2oQueryDatasource datasource = initInlineDatasource(widget, source, p);
    ...
    @Override
    protected N2oQueryDatasource initInlineDatasource(HtmlWidget compiled, N2oHtmlWidget source, CompileProcessor p) {
