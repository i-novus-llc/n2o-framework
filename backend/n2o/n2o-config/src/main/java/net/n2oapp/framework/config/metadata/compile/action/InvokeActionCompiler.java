...
public class InvokeActionCompiler extends AbstractMetaActionCompiler<InvokeAction, N2oInvokeAction> {
    ...
    public InvokeAction compile(N2oInvokeAction source, CompileContext<?, ?> context, CompileProcessor p) {
        ...
        invokeAction.getPayload().setField(getField(p));
        invokeAction.getPayload().setWidgetId(getClientDatasourceId(getDatasourceIdByComponentScope(p), p));
    ...
    protected void initDefaults(N2oInvokeAction source, CompileProcessor p) {
        ...
        source.setRoute(castDefault(RouteUtil.normalizeRoute(source.getRoute()), "/" + source.getId()));
    ...
    private void initDataProvider(InvokeAction invokeAction, N2oInvokeAction source,
        ...
        dataProvider.setUrl(RouteUtil.normalizeRoute(source.getRoute()));
