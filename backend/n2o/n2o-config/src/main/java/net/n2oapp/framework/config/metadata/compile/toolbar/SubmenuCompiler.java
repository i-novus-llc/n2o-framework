 ...
 */
@Component
public class SubmenuCompiler extends BaseButtonCompiler<N2oSubmenu> implements MetadataEnvironmentAware {
    ...
    @Override
    public Button compile(N2oSubmenu sub, CompileContext<?, ?> context, CompileProcessor p) {
