 ...
 */
@Component
public class N2oInvokeActionV5AdapterTransformer implements SourceTransformer<N2oInvokeAction>, SourceClassAware {
    @Override
    ...
    @Override
    public N2oInvokeAction transform(N2oInvokeAction source, SourceProcessor p) {
