...
import net.n2oapp.framework.config.io.widget.charts.ChartIOv5;
...
public class ChartWidgetIOv5 extends WidgetElementIOv5<N2oChart> {
    ...
    public void io(Element e, N2oChart c, IOProcessor p) {
        ...
        p.anyChild(e, null, c::getComponent, c::setComponent, p.anyOf(N2oAbstractChart.class).ignore("datasource"), ChartIOv5.NAMESPACE);
