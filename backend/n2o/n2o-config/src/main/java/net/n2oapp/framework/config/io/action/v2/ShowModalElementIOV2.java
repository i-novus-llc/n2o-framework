...
public class ShowModalElementIOV2 extends AbstractOpenPageElementIOV2<N2oShowModal> {
    ...
    public void io(Element e, N2oShowModal sm, IOProcessor p) {
        ...
        p.attributeEnum(e, "copy-ref-page", sm::getCopyPage, sm::setCopyPage, PageRef.class);
        ...
        p.attributeEnum(e, "target-ref-page", sm::getTargetPage, sm::setTargetPage, PageRef.class);
