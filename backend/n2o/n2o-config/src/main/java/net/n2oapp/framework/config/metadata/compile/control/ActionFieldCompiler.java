...
public abstract class ActionFieldCompiler<D extends ActionField, S extends N2oActionField> extends FieldCompiler<D, S> {
    ...
    protected Action compileAction(N2oActionField source, ActionField field, CompileContext<?, ?> context,
        ...
        Action action = ActionCompileStaticProcessor.compileAction(source, context, p, null, scopes);
