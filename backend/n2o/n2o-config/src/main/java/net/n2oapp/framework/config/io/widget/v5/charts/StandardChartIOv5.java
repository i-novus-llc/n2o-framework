...
/**
 * Чтение/запись стандартного компонента диаграммы  версии 5.0
 */
@Component
public abstract class StandardChartIOv5<T extends N2oStandardChart> extends AbstractChartIOv5<T> {
