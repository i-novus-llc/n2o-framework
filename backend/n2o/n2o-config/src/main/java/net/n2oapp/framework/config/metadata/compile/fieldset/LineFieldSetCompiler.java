...
public class LineFieldSetCompiler extends AbstractFieldSetCompiler<LineFieldSet, N2oLineFieldSet> {
    ...
    public LineFieldSet compile(N2oLineFieldSet source, CompileContext<?, ?> context, CompileProcessor p) {
        ...
        fieldSet.setCollapsible(p.cast(source.getCollapsible(), p.resolve(property("n2o.api.fieldset.line.collapsible"), Boolean.class)));
        fieldSet.setHasSeparator(p.cast(source.getHasSeparator(), p.resolve(property("n2o.api.fieldset.line.has_separator"), Boolean.class)));
        fieldSet.setExpand(p.cast(source.getExpand(), p.resolve(property("n2o.api.fieldset.line.expand"), Boolean.class)));
        fieldSet.setLabel(source.getLabel());
        fieldSet.setSrc(p.cast(source.getSrc(), p.resolve(property("n2o.api.fieldset.line.src"), String.class)));
