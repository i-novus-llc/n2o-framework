...
public class RadioGroupCompiler extends ListControlCompiler<RadioGroup, N2oRadioGroup> {
    ...
    public StandardField<RadioGroup> compile(N2oRadioGroup source, CompileContext<?, ?> context, CompileProcessor p) {
        ...
        radioGroup.setInline(p.cast(source.getInline(), source.getType() == N2oRadioGroup.RadioGroupType.tabs ? p.resolve(property("n2o.api.control.radiogroup.tabs_inline"), Boolean.class) : p.resolve(property("n2o.api.control.alt.inline"), Boolean.class)));
