...
/**
 * Компиляция абстрактной диаграммы
 */
@Component
public abstract class AbstractChartCompiler<D extends ChartWidgetComponent, S extends N2oAbstractChartComponent> implements BaseSourceCompiler<D, S, CompileContext<?,?>> {
