...
public class LeftRightPageElementIOv2 extends BasePageElementIOv2<N2oLeftRightPage> {
    ...
    public void io(Element e, N2oLeftRightPage m, IOProcessor p) {
        super.io(e, m, p);
        p.anyChildren(e, "left", m::getLeft, m::setLeft, p.anyOf(N2oAbstractRegion.class), getRegionDefaultNamespace());
        p.childAttribute(e, "left", "width", m::getLeftWidth, m::setLeftWidth);
        p.anyChildren(e, "right", m::getRight, m::setRight, p.anyOf(N2oAbstractRegion.class), getRegionDefaultNamespace());
