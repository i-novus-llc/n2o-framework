...
public class DateIntervalJsonTest extends JsonMetadataTestBase {
    ...
    public void tabsDateInterval() {
        check("net/n2oapp/framework/config/mapping/testDateInterval.widget.xml",
                ...
                .exclude("src", "value", "defaultValue", "outputFormat", "placeholder", "readOnly", "popupPlacement", "disabled", "locale", "value", "timeFormat", "defaultTime", "min", "max") /// TODO: ждем, когда будет реализовано на сервере
                .assertEquals();
    }
}
