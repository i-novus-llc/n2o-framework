...
class OnFailActionValidatorTest extends SourceValidationTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        builder.packs(new N2oPagesPack(), new N2oActionsPack(), new N2oAllValidatorsPack());
    }
    ...
    void testMultiActionWithCloseValid() {
        validate("net/n2oapp/framework/config/metadata/validation/action/on_fail/testMultiActionWithCloseValid.page.xml");
    }
}
