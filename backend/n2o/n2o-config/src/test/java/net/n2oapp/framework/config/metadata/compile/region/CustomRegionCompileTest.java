...
public class CustomRegionCompileTest extends SourceCompileTestBase {
    ...
    public void testNesting() {
        ...
        // region form2
        assertThat(content.get(0), instanceOf(Form.class));
        assertThat(((Form) content.get(0)).getId(), is("testCustomRegionNesting_w2"));
        assertThat(((Form) content.get(0)).getName(), is("form2"));
        ...
        assertThat(((Form) regionContent.get(0)).getId(), is("testCustomRegionNesting_w3"));
        assertThat(((Form) regionContent.get(0)).getName(), is("form3"));

        // region form4
        assertThat(content.get(2), instanceOf(Form.class));
        assertThat(((Form) content.get(2)).getId(), is("testCustomRegionNesting_w4"));
        ...
        // region form5
        assertThat(content.get(0), instanceOf(Form.class));
        assertThat(((Form) content.get(0)).getId(), is("testCustomRegionNesting_w5"));
        assertThat(((Form) content.get(0)).getName(), is("form5"));
    }
