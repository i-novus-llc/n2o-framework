...
public class ButtonDependencyCompileTest extends SourceCompileTestBase {
    ...
    void testButtonDependency() {
        ...
        Condition condition = buttons.get(1).getConditions().get(ValidationType.visible).get(0);
        ...
        condition = buttons.get(1).getConditions().get(ValidationType.enabled).get(0);
        assertThat(condition.getModelLink(), is("models.resolve['testButtonDependency_table']"));
        ...
        condition = buttons.get(4).getConditions().get(ValidationType.visible).get(0);
        ...
        condition = buttons.get(5).getConditions().get(ValidationType.enabled).get(0);
        assertThat(condition.getModelLink(), is("models.resolve['testButtonDependency_table']"));
        assertThat(condition.getExpression(), is("!$.isEmptyModel(this)"));
        condition = buttons.get(5).getConditions().get(ValidationType.enabled).get(1);
        assertThat(condition.getModelLink(), is("models.resolve['testButtonDependency_table']"));
