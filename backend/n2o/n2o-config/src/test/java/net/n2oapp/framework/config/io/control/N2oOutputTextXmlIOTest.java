...
/**
 * Тестирование чтения и записи контрола OutputText из/в xml-файла
 */
public class N2oOutputTextXmlIOTest extends N2oStandardControlReaderTestBase {
    ...
    @Test
    public void testOutputTextXmlIO(){
        ...
        assert tester.check("net/n2oapp/framework/config/io/control/testOutputTextReader.fieldset.xml",
                (N2oFieldSet fieldSet) -> {
                    assertCountField(fieldSet, 1);
                    N2oOutputText outputText = (N2oOutputText) fieldSet.getItems()[0];
                    assertStandardAttribute(outputText);
                });
    }
}
