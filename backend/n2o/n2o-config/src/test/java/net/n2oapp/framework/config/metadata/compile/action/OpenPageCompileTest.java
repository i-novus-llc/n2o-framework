...
class OpenPageCompileTest extends SourceCompileTestBase {
    ...
    void filterModel() {
        ...
        assertThat(openPage.getBreadcrumb().getFirst().getLabel(), is("first"));
        assertThat(openPage.getBreadcrumb().get(1).getLabel(), is("second"));

        InvokeAction submit = (InvokeAction) ((MultiAction) openPage.getToolbar().getButton("submit").getAction()).getPayload().getActions().getFirst();
    ...
    void resolveModel() {
        ...
        assertThat(context.getPreFilters().getFirst().getRefPageId(), is("page"));
        assertThat(context.getPreFilters().getFirst().getDatasourceId(), is("test"));
        assertThat(context.getPreFilters().getFirst().getModel(), is(ReduxModelEnum.RESOLVE));
        assertThat(context.getPreFilters().getFirst().getParam(), is("page_test_id"));
        assertThat(context.getPreFilters().getFirst().getType(), is(FilterTypeEnum.EQ));
        ...
        assertThat(context.getParentModelLinks().getFirst().getFieldId(), is("id"));
        assertThat(context.getParentModelLinks().getFirst().getDatasource(), is("page_test"));
        assertThat(context.getParentModelLinks().getFirst().getSubModelQuery(), nullValue());
    ...
    void breadcrumb() {
        ...
        assertThat(level3Page.getBreadcrumb().getFirst().getLabel(), is("parent"));
        assertThat(level3Page.getBreadcrumb().getFirst().getPath(), is("/page/123/"));
    ...
    private static void checkPage(Page masterDetailPage, String o, String path) {
        ...
        assertThat(masterDetailPage.getBreadcrumb().getFirst().getLabel(), is("parent"));
        assertThat(masterDetailPage.getBreadcrumb().getFirst().getPath(), is("/page/123/"));
    ...
    void masterDetail() {
        ...
        assertThat(context.getPreFilters().getFirst().getDatasourceId(), is("test"));
        assertThat(context.getPreFilters().getFirst().getModel(), is(ReduxModelEnum.RESOLVE));
        assertThat(context.getPreFilters().getFirst().getValue(), is("{masterId}"));
        assertThat(context.getPreFilters().getFirst().getType(), is(FilterTypeEnum.EQ));
        ...
        Widget openPageWidget = ((Widget) openPage.getRegions().get("single").getFirst().getContent().getFirst());
    ...
    private void checkDetailContext(PageContext context) {
        ...
        assertThat(detailPage.getRoutes().getSet().contains("/page/:page_test_id/masterDetail/"), is(true));
        Widget detailPageWidget = (Widget) detailPage.getRegions().get("single").getFirst().getContent().getFirst();
    ...
    void testMasterParam() {
        ...
        ShowModal showModal = (ShowModal) ((Form) p2.getRegions().get("single").getFirst().getContent().getFirst()).getToolbar().getButton("byName").getAction();
    ...
    void testDefaultParam() {
        ...
        Map<String, ModelLink> queryMapping1 = ((InputSelect) ((StandardField) ((Form) openPage.getWidget()).getComponent()
                .getFieldsets().getFirst().getRows().getFirst().getCols().getFirst().getFields().getFirst()).getControl()).getDataProvider().getQueryMapping();
    ...
    void testPathParam() {
        ...
        PerformButton btn1 = (PerformButton) ((Widget) page.getRegions().get("single").getFirst().getContent().getFirst()).getToolbar().getButton("btn1");
        ...
        PerformButton btn2 = (PerformButton) ((Widget) page.getRegions().get("single").getFirst().getContent().getFirst()).getToolbar().getButton("btn2");
    ...
    void link() {
        ...
        assertThat(((LinkActionImpl) link).getPayload().getNewWindow(), is(false));

        link = (LinkAction) toolbar.getButton("id2").getAction();
        assertThat(link.getUrl(), is("/testSimpleOpenPage/view/"));
        assertThat(link.getTarget(), is(TargetEnum.APPLICATION));
        assertThat(((LinkActionImpl) link).getPayload().getNewWindow(), is(true));
    }
    ...
    void testCustomBreadcrumb() {
        ...
        assertThat(openPage.getBreadcrumb().getFirst().getLabel(), is("First"));
        assertThat(openPage.getBreadcrumb().getFirst().getPath(), is("/"));
        assertThat(openPage.getBreadcrumb().get(1).getLabel(), is("Second"));
