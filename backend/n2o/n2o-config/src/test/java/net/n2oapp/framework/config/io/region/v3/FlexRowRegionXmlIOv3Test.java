...
/**
 * Тестирование чтения/записи региона {@code <flex-row>} версии 3.0
 */
class FlexRowRegionXmlIOv3Test {
    ...
    void test() {
        ...
        assert tester.check("net/n2oapp/framework/config/io/region/v3/testFlexRowRegionXmlIOv3.region.xml");
    }
}