...
/**
 * Тестирование валидации региона {@code <col>}
 */
class ColRegionValidatorTest extends SourceValidationTestBase {
    @Override
    @BeforeEach
    public void setUp() {
        super.setUp();
    ...
    void testMultiActionWithClose() {
        N2oMetadataValidationException exception = assertThrows(
                ...
                () -> validate("net/n2oapp/framework/config/metadata/validation/region/col/testMultiActionWithClose.page.xml"));
