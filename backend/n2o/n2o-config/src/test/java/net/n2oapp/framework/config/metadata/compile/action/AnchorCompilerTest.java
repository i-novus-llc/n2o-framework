...
public class AnchorCompilerTest extends SourceCompileTestBase {
    ...
    public void testAnchor() {
        ...
        link1 = (LinkActionImpl)modalPage.getWidgets().get("page_widget_id4_test").getActions().get("id1");
        ...
        link2 = (LinkActionImpl)modalPage.getWidgets().get("page_widget_id4_test").getActions().get("id2");
        ...
        link3 = (LinkActionImpl)modalPage.getWidgets().get("page_widget_id4_test").getActions().get("id3");
