...
class EditCellCompileTest extends SourceCompileTestBase {
    ...
    void testCompileEditCell() {
        ...
        EditCell cell = (EditCell) table.getComponent().getBody().getCells().getFirst();
        ...
        cell = (EditCell) table.getComponent().getBody().getCells().get(2);
        assertThat(cell.getSrc(), is("EditableCell"));
        assertThat(cell.getControl(), instanceOf(TextArea.class));
        assertThat(cell.getControl().getSrc(), is("TextArea"));
        assertThat(((TextArea) cell.getControl()).getMaxRows(), is(3));
        assertThat(((TextArea) cell.getControl()).getMinRows(), is(1));
    }
}
