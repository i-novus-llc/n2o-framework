...
public class FieldDependencyJsonTest extends JsonMetadataTestBase {
    ...
    public void testFieldDependency() {
        check("net/n2oapp/framework/config/metadata/compile/dependency/testFieldDependency.widget.xml",
                ...
                .exclude("fetchOnInit", "autoFocus", "fieldDefaultValues", "filterDefaultValues", "prompt",
                        ...
                        "fieldsets[0].rows[0].cols[1].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[1].cols[0].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[1].cols[1].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[2].cols[0].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[2].cols[1].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[2].cols[2].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[3].cols[0].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[3].cols[1].fields[0].control.id",
                        ...
                        "fieldsets[0].rows[3].cols[2].fields[0].control.id",
