...
public class TestInvocationTransformTest extends SourceTransformTestBase {
    ...
    public void test() {
        ...
        assertThat(((QuerySimpleField) query.getFields()[0]).getSelectExpression(), is(":expression"));
        assertThat(((QuerySimpleField) query.getFields()[0]).getSortingExpression(), is(":expression :idDirection"));
