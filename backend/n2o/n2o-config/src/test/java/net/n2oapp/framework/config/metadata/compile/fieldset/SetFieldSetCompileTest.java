...
public class SetFieldSetCompileTest extends SourceCompileTestBase {
    ...
    public void testSetFielsetWithField() {
        ...
        // проверка вложения колонок в строки
        List<FieldSet> colFieldSets = rows.get(9).getCols().get(0).getFieldsets();
        assertThat(colFieldSets.size(), is(5));
        assertThat(colFieldSets.get(0).getRows().size(), is(2));
        assertThat(colFieldSets.get(0).getRows().get(0).getCols().size(), is(2));
        assertThat(colFieldSets.get(0).getRows().get(0).getCols().get(0).getFields().get(0).getId(), is("id1"));
        assertThat(colFieldSets.get(0).getRows().get(0).getCols().get(1).getFields().get(0).getId(), is("id2"));
        assertThat(colFieldSets.get(0).getRows().get(1).getCols().size(), is(1));
        assertThat(colFieldSets.get(0).getRows().get(1).getCols().get(0).getFields().get(0).getId(), is("id3"));
        assertThat(colFieldSets.get(1).getRows().size(), is(1));
        assertThat(colFieldSets.get(1).getRows().get(0).getCols().size(), is(1));
        assertThat(colFieldSets.get(1).getRows().get(0).getCols().get(0).getFields().get(0).getId(), is("id4"));
        assertThat(colFieldSets.get(2).getRows().size(), is(1));
        assertThat(colFieldSets.get(2).getRows().get(0).getCols().size(), is(1));
        assertThat(colFieldSets.get(2).getRows().get(0).getCols().get(0).getFields().get(0).getId(), is("id5"));
        assertThat(colFieldSets.get(3).getRows().size(), is(1));
        assertThat(colFieldSets.get(3).getRows().get(0).getCols().size(), is(1));
        assertThat(colFieldSets.get(3).getRows().get(0).getCols().get(0).getFields().get(0).getId(), is("id6"));
        assertThat(colFieldSets.get(4).getRows().size(), is(2));
        assertThat(colFieldSets.get(4).getRows().get(0).getCols().size(), is(1));
        assertThat(colFieldSets.get(4).getRows().get(0).getCols().get(0).getFields().get(0).getId(), is("id7"));
        assertThat(colFieldSets.get(4).getRows().get(1).getCols().size(), is(1));
        assertThat(colFieldSets.get(4).getRows().get(1).getCols().get(0).getFields().get(0).getId(), is("id8"));
