...
public class MongodbEngineQueryTransformerTest extends SourceCompileTestBase {
    ...
    public void testMomgodbTransformer() {
        ...
        assertThat(((QuerySimpleField) query.getFields()[1]).getSelectExpression(), is(":expression"));
        assertThat(query.getFields()[1].getMapping(), nullValue());
        assertThat(((QuerySimpleField) query.getFields()[1]).getSortingExpression(), is(":expression :nameDirection"));
