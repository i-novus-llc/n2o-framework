...
import net.n2oapp.framework.config.io.control.interval.BaseIntervalFieldIOv3;
 ...
 */
class N2OBaseIntervalFieldXmlIOv3Test extends XmlIOTestBase {
    ...
    @Test
    void test() {
        check("net/n2oapp/framework/config/io/control/testBaseIntervalControlV3.xml");
    }
}
