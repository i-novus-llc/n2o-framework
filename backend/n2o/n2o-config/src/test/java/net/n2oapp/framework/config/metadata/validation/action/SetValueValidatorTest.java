...
public class SetValueValidatorTest extends SourceValidationTestBase {
    ...
    void testSourceDatasourceExistence() {
        ...
        assertEquals("В действии <set-value> указан несуществующий источник данных 'source-datasource = test'", exception.getMessage());
    }
    ...
    void testTargetDatasourceExistence() {
        ...
        assertEquals("В действии <set-value> указан несуществующий источник данных 'target-datasource = ds'", exception.getMessage());
    }
}
