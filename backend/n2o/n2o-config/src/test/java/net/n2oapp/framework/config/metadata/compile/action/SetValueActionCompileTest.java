...
public class SetValueActionCompileTest extends SourceCompileTestBase {
    ...
    public void simple() {
        ...
        SetValueAction testAction = (SetValueAction) table.getToolbar().getButton("test").getActions().get(0);
        ...
        SetValueAction menuItem0action = (SetValueAction) table.getToolbar().getButton("test2").getActions().get(0);
