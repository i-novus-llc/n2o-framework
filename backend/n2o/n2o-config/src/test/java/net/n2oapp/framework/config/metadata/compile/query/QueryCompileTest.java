...
public class QueryCompileTest extends SourceCompileTestBase {
    ...
    public void testExpression() {
        ...
        SimpleField manual = query.getFieldsMap().get("manual");
        ...
        SimpleField auto = query.getFieldsMap().get("auto");
...
//        assert query.getUniques() == null;
        ...
        SimpleField testFilter = query.getFieldsMap().get("testFilter");
        ...
        SimpleField withEmptySelect = query.getFieldsMap().get("withEmptySelect");
