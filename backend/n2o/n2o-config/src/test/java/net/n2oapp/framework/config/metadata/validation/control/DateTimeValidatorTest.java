...
public class DateTimeValidatorTest extends SourceValidationTestBase {
    ...
    void testDefaultValue() {
        ...
        assertEquals("Значение 'default-value' поля 'test' виджета 'testDefValueDateTime' должно иметь формат yyyy-MM-dd HH:mm:ss", exception.getMessage());
    }
