...
import net.n2oapp.framework.config.io.action.RefreshActionElementIOV2;
...
class SubPageRegionXmlIOv3Test {
    ...
    void test() {
        ...
        assert tester.check("net/n2oapp/framework/config/io/region/testSubPageRegionXmlIOv3.region.xml");
    }
}
