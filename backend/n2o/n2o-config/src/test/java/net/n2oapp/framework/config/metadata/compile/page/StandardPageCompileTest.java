...
public class StandardPageCompileTest extends SourceCompileTestBase {
    ...
    public void routes() {
        ...
        assertThat(((PageContext) route("/page/1").getContext(Page.class)).getClientPageId(), is(context.getClientPageId()));
        assertThat(((PageContext) route("/page/1/detail/2").getContext(Page.class)).getBreadcrumbs(), is(context.getBreadcrumbs()));
        assertThat(((PageContext) route("/page/1/detail/2/detail4").getContext(Page.class)).getClientPageId(), is(context.getClientPageId()));
        assertThat(((PageContext) route("/page/1/detail/2/detail4/3").getContext(Page.class)).getBreadcrumbs(), is(context.getBreadcrumbs()));
    }
