...
public class StandardPageCompileTest extends SourceCompileTestBase {
    ...
    public void routes() {
        ...
        assertThat(((PageContext)routeContext("/page/master/1", Page.class)).getClientPageId(), is(context.getClientPageId()));
        assertThat(((PageContext)routeContext("/page/master/1/detail/2", Page.class)).getBreadcrumbs(), is(context.getBreadcrumbs()));
        assertThat(((PageContext)routeContext("/page/master/1/detail/2/detail4", Page.class)).getClientPageId(), is(context.getClientPageId()));
        assertThat(((PageContext)routeContext("/page/master/1/detail/2/detail4/3", Page.class)).getBreadcrumbs(), is(context.getBreadcrumbs()));
    }
    ...
    public void masterDetails() {
        ...
        assertThat(((QueryContext)routeContext("/testStandardPageDependency/master/:testStandardPageDependency_master_id/detail", CompiledQuery.class)).getFilters().size(), is(1));
        assertThat(((QueryContext)routeContext("/testStandardPageDependency/master/:testStandardPageDependency_master_id/detail", CompiledQuery.class)).getFilters().get(0).getParam(), is("testStandardPageDependency_master_id"));
    ...
    public void preFilters() {
        ...
        QueryContext queryCompileContext = (QueryContext) routeContext("/testWidgetPrefilters/master1/:testWidgetPrefilters_master1_id/detail1", CompiledQuery.class);
        ...
        queryCompileContext = (QueryContext) routeContext("/testWidgetPrefilters/detail2", CompiledQuery.class);
