...
import net.n2oapp.framework.config.metadata.validation.standard.datasource.AppDatasourceValidator;
...
public class ApplicationDatasourceValidatorTest extends SourceValidationTestBase {
    ...
    protected void configure(N2oApplicationBuilder builder) {
        ...
        builder.validators(new PageValidator(), new WidgetValidator(), new BasePageValidator(), new AppDatasourceValidator());
