...
public class QueryDataSourceCompileTest extends SourceCompileTestBase {
    ...
    public void simple() {
        ...
        Datasource ds = (Datasource) page.getDatasources().get("testDSStandardPage_ds1");
        ...
        ds = (Datasource) simplePage.getDatasources().get("testDSSimplePage_main");
        assertThat(ds, notNullValue());
        assertThat(ds.getDefaultValuesMode(), is(DefaultValuesMode.defaults));
        assertThat(ds.getProvider(), nullValue());
    }
    ...
    public void query() {
        ...
        Datasource ds = (Datasource) page.getDatasources().get("_ds1");
        assertThat(ds, notNullValue());
    ...
    public void queryFilters() {
        ...
        Datasource ds = (Datasource) page.getDatasources().get("p_w_a_ds1");
        ...
        ds = (Datasource) page.getDatasources().get("p_w_a_ds2");
    ...
    public void fetch() {
        ...
        Datasource ds = (Datasource) page.getDatasources().get("p_w_a_detail");
    ...
    public void submit() {
        ...
        //        with messages
        ds = (Datasource) page.getDatasources().get("p_w_a_ds3");
        assertThat(ds.getSubmit(), Matchers.notNullValue());
        ...
        //        with path-param
        ds = (Datasource) page.getDatasources().get("p_w_a_ds4");
        assertThat(ds.getSubmit(), Matchers.notNullValue());
