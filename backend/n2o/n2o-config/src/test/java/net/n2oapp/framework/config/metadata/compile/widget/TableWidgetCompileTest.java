...
public class TableWidgetCompileTest extends SourceCompileTestBase {
    ...
    public void testFilters() {
        ...
        assertThat(table.getDataProvider().getQueryMapping().get("name").getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(table.getDataProvider().getQueryMapping().get("name").getValue(), is("`name`"));
        assertThat(table.getDataProvider().getQueryMapping().get("birthday_begin").getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(table.getDataProvider().getQueryMapping().get("birthday_begin").getValue(), is("`birthday.begin`"));
        assertThat(table.getDataProvider().getQueryMapping().get("birthday_end").getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(table.getDataProvider().getQueryMapping().get("birthday_end").getValue(), is("`birthday.end`"));
        assertThat(table.getDataProvider().getQueryMapping().get("gender_id").getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(table.getDataProvider().getQueryMapping().get("gender_id").getValue(), is("`gender.map(function(t){return t.id})`"));
        assertThat(table.getDataProvider().getQueryMapping().get("gender_name").getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(table.getDataProvider().getQueryMapping().get("gender_name").getValue(), is("`gender.map(function(t){return t.name})`"));

        assertThat(page.getRoutes().getQueryMapping().size(), is(6));
        assertThat(page.getRoutes().getQueryMapping().get("name").getOnSet().getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(page.getRoutes().getQueryMapping().get("name").getOnSet().getValue(), is("`name`"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_begin").getOnSet().getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_begin").getOnSet().getValue(), is("`birthday.begin`"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_end").getOnSet().getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_end").getOnSet().getValue(), is("`birthday.end`"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnSet().getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnSet().getValue(), is("`gender.map(function(t){return t.id})`"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnSet().getBindLink(), is("models.filter['testTable4FiltersCompile_main']"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnSet().getValue(), is("`gender.map(function(t){return t.name})`"));

        assertThat(page.getRoutes().getQueryMapping().get("name").getOnGet().getPayload().get("value"), is(":name"));
        assertThat(page.getRoutes().getQueryMapping().get("name").getOnGet().getType(), is("n2o/models/UPDATE"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_begin").getOnGet().getPayload().get("value"), is(":birthday_begin"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_begin").getOnGet().getType(), is("n2o/models/UPDATE"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_end").getOnGet().getPayload().get("value"), is(":birthday_end"));
        assertThat(page.getRoutes().getQueryMapping().get("birthday_end").getOnGet().getType(), is("n2o/models/UPDATE"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnGet().getPayload().get("value"), is(":gender_id"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnGet().getType(), is("n2o/models/UPDATE_MAP"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnGet().getPayload().get("map"), is("id"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_id").getOnGet().getPayload().get("field"), is("gender"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnGet().getPayload().get("value"), is(":gender_name"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnGet().getPayload().get("map"), is("name"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnGet().getPayload().get("field"), is("gender"));
        assertThat(page.getRoutes().getQueryMapping().get("gender_name").getOnGet().getType(), is("n2o/models/UPDATE_MAP"));
