...
class OpenDrawerCompileTest extends SourceCompileTestBase {
    ...
    void create() {
        ...
        OpenDrawerPayload defaultPayload = ((OpenDrawer) table.getToolbar().getButton("default").getAction()).getPayload();
        assertThat(defaultPayload.getBackdrop(), is("static"));
    ...
    void update() {
        ...
        assertThat(payload.getBackdrop(), is(false));
        ...
        assertThat(((StandardDatasource) drawerPage.getDatasources().get(drawerPage.getWidget().getId())).getProvider().getUrl(),
                is("n2o/data/p/222/update/w1/"));
    }
