...
import net.n2oapp.framework.config.io.control.TextFieldIOv3;
...
class XmlMetadataLoaderTest {
    ...
    void testLoadWithParams() {
        ...
        XmlMetadataLoader xmlMetadataLoader = new XmlMetadataLoader(
                new ReaderFactoryByMap(null).register(new SimplePageElementIOv4()).register(new FormElementIOV5()).register(new InputTextIOv3()));
