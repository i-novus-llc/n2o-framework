...
import net.n2oapp.framework.config.io.control.list.InputSelectTreeIOv3;
...
class N2oInputSelectTreeXmlIOv3Test {
    ...
    void test() {
        ...
        assert tester.check("net/n2oapp/framework/config/io/control/testInputSelectTreeV3.widget.xml");
    }
}