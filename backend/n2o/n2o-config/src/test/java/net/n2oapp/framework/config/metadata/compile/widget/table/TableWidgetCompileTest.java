...
public class TableWidgetCompileTest extends SourceCompileTestBase {
    ...
    public void testFilters() {
        ...
        //pre-filter name
        ModelLink nameLink = ((Datasource) page.getDatasources().get("page_main")).getProvider().getQueryMapping().get("nameParam");
        ...
        ModelLink birthdayBeginLink = ((Datasource) page.getDatasources().get("page_main")).getProvider().getQueryMapping().get("main_birthday_begin");
        ModelLink birthdayEndLink = ((Datasource) page.getDatasources().get("page_main")).getProvider().getQueryMapping().get("main_birthday_end");
        ...
        ModelLink gendersLink = ((Datasource) page.getDatasources().get("page_main")).getProvider().getQueryMapping().get("main_genders_id");
    ...
    public void testFilterColumns() {
        ...
        BindLink link = ((Datasource) page.getDatasources().get("testFilterColumns_main")).getProvider().getQueryMapping().get("main_name");
    ...
    public void testMultiColumn() {
        ...
        BindLink link = ((Datasource) page.getDatasources().get("testMultiColumn_table")).getProvider().getQueryMapping().get("table_name");
        assertThat(link.getValue(), is("`name`"));
