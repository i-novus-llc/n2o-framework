...
public interface ProtoPageSelectors extends BasePage {
    ...
    default SelenideElement getFilterName() {
        return getMainTableFilter().$$(".n2o-input").get(1);
    }
    ...
    default SelenideElement getFilterVip() {
        return getMainTableFilter().$$(".n2o-checkbox").findBy(Condition.text("VIP"));
    }
