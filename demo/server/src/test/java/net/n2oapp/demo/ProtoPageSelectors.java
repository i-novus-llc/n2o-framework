...
public interface ProtoPageSelectors extends BasePage {
    ...
    default SelenideElement getFilterBirthdayStart() {
        return getMainTableFilter().$$("input").get(2);
    }

    default SelenideElement getFilterBirthdayEnd() {
        return getMainTableFilter().$$("input").get(3);
    }
