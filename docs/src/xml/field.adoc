...
[source,xml]
----
<date-time id="date" date-format="DD.MM.YYYY" min="01.01.2018" max="01.01.2019" utc="true"/>
----
...
[source,xml]
----
<date-interval id="interval" date-format="DD/MM/YYYY" min="5/12/2012" max="15/12/2021" utc="false"/>
----
