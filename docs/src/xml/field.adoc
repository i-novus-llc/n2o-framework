...
|search-filter-id
|Поле фильтра выборки
|Поле фильтра выборки (filter-id), отвечающее за поиск вариантов выбора
|Фильтр <like> или <eq> у поля label-field-id
