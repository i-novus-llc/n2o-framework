...
|title-field-id
|Строка
|Поле выборки, отвечающее за заголовок ячейки
|

|tooltip-field-id
|Строка
|Поле выборки, отвечающее за данные тултипа ячейки
|

|all-day-field-id
|Строка
|Поле выборки, отвечающее за
|
...
|cell-color-field-id
|Строка
|Поле выборки, отвечающее за цвет ячейки
|
...
<calendar
  ...
  title-field-id = "title" tooltip-field-id = "tooltip" all-day-field-id = "allDay"
...
Ресурсы используются для разбиения календаря не на дни,
а на определенные сущности.
