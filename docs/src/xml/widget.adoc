...
|show-single-page
|true false
|Показать паджинацию на единственной странице
|false

|layout
|bordered, flat, separated, bordered-rounded, flat-rounded, separated-rounded
|Устанавливает представление компонента
|separated
...
|first-label
|Строка
|Текст кнопки "Первая страница"
|

|first-icon
|http://fontawesome.io/icons/[CSS класс]
|Иконка кнопки "Первая страница"
|fa fa-angle-double-left

|last-label
|Строка
|Текст кнопки "Последняя страница"
|

|last-icon
|http://fontawesome.io/icons/[CSS класс]
|Иконка кнопки "Последняя страница"
...
|default-values-query-id
|Строка
|Идентификатор запроса значений по умолчанию для фильтров
|
