...
|min-date
|Строка
|Минимальная отображаемая дата
|

|max-date
|Строка
|Максимальная отображаемая дата
|
...
|all-day-field-id
|Строка
|Поле выборки, отвечающее за данные события, занимающего весь день
|
...
<calendar
  ...
  min-date="2020-04-01" max-date="2020-05-15" min-time="08:00:00" max-time="20:00:00"
