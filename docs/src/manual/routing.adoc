...
----
link:https://n2oapp.net/sandbox/editor/manual_routing_header/[Пример]
```
...
<simple-page>
----
link:https://n2oapp.net/sandbox/editor/manual_routing_widget/[Пример]
```
...
----
link:https://n2oapp.net/sandbox/editor/manual_routing_widget_master_detail/[Пример]
```
...
link:https://n2oapp.net/sandbox/editor/manual_routing_widget_master_param/[Пример]
...
----
link:https://n2oapp.net/sandbox/editor/manual_routing_page/[Пример]
```
...
----
link:https://n2oapp.net/sandbox/editor/manual_routing_query/[Пример]
```
