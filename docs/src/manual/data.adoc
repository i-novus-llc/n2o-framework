...
----
link:https://n2oapp.net/sandbox/new/data/providers/mapping_java_primitive[Пример]
...
----
link:https://n2oapp.net/sandbox/new/data/providers/mapping_java_entity[Пример]
...
@Service
class MyService {
  public Page<Person> getList(MyCriteria criteria)  { ... }
}
----

[source,java]
----
class MyCriteria implements Pageable {
  private Date birtdayBefore;
  private Date birtdayAfter;
  //getters and setters
}
----
link:https://n2oapp.net/sandbox/new/data/providers/mapping_java_criteria[Пример]
