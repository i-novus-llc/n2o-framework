...
Так же можно вкладывать виджеты в страницу:
...
==== Кнопка
Кнопка - это визуальный элемент, на который можно нажать выполнив действие.
...
Redux действия меняют состояние React компонентов и отправляют запросы на сервер.
...
На одно и тоже действие виджета можно ссылаться из различных мест, например, из кнопок:
...
Описание других видов полей можно посмотреть link:docs/xml/#_Поля_ввода[здесь].
