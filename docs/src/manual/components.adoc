...
|<left-right-page>
|LeftRightPage
|link:https://n2oapp.net/sandbox/new/manual/page/left-right[Страница с разметкой регионов "слева и справа"]

|<top-left-right-page>
|TopLeftRightPage
|link:https://n2oapp.net/sandbox/new/manual/page/top-left-right[Страница с разметкой регионов "сверху, слева и справа"]
