...
stories
  .add(
    ...
    },
    {
      ...
      ~~~js
      import ButtonUploader from 'n2o/lib/components/controls/FileUploader/ButtonUploader';
  ...
  .add(
    ...
    },
    {
      ...
      Компонент 'Загрузчик файлов'
      ~~~js
      import DropZone from 'n2o/lib/components/controls/FileUploader/DropZone';
