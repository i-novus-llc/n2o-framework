...
|Наименование             |Тип                                                                   |Описание                                                                                                                                                                                        |Значение по умолчанию           |
|-------------------------|----------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|
|action-ids               |Список ссылок на [действия страницы](..xml/page#actions#action)       |Действия страницы, которые будут вызваны при нажатии на кнопку                                                                                                                                  |                                |
...
```xml
<button action-ids="submit,create" enabled="{type=='type1'}"/>
```
