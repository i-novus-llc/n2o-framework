...
[Источники данных](../xml/application#datasources), [События](../xml/application#events), [Шапка(header)](../xml/application#header), [Боковые панели](../xml/application#sidebars), [Подвал(footer)](../xml/application#footer)

### Источники данных (&lt;datasources&gt;) {#datasources}
...
### Стандартный источник данных (&lt;datasource&gt;) {#datasource}
...
### STOMP-источник данных (&lt;stomp-datasource&gt;) {#stomp-datasource}
...
### Значения на момент инициализации (&lt;values&gt;) {#values}
...
### Инициализирующее значение(имя атрибута задается пользователем) (&lt;value&gt;) {#value}
...
[Стандартный источник данных](../xml/application#datasource), [Навигационная панель](../xml/application#navigation)
...
|datasource      |Строка         |Источник данных боковой панели                  |                     |
