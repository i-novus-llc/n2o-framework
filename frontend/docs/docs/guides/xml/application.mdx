...
[Источники данных](../xml/application#datasources), [События](../xml/application#events), [Шапка(header)](../xml/application#header), [Боковая панель](../xml/application#sidebar), [Подвал(footer)](../xml/application#footer)
