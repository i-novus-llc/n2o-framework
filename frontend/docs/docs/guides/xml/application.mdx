...
|sidebar-icon         |[Класс иконки](https://fontawesome.com/v4.7/icons/)|Иконка открытия боковой панели, если не задана, значит кнопки не будет                         |                     |
|sidebar-toggled-icon |[Класс иконки](https://fontawesome.com/v4.7/icons/)|Иконка скрытия боковой панели, если не задана, значит кнопки не будет                          |                     |
