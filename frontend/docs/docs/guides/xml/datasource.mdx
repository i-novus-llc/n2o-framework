...
|model        |filter resolve edit datasource multi |Модель текущего источника данных, которая будет сохранена     |resolve                        |
...
|source-model      |filter resolve edit datasource multi      |Модель источника данных, из которой будут скопированы данные         |resolve               |
...
|target-model      |filter resolve edit datasource multi      |Модель источника данных, в которую производится сохранение        |Модель источника данных, из которой будут скопированы данные         |
...
|model        |filter resolve edit datasource multi      |Модель зависимого источника данных        |resolve               |
...
|source-model    |filter resolve edit datasource multi      |Модель источника данных, из которой будут скопированы данные              |resolve               |
|target-model    |filter resolve edit datasource multi      |Модель текущего источника, в которую будут скопированы данные             |resolve               |
|source-field-id |Строка                                    |Идентификатор поля, из которого будут скопированы данные                  |Вся модель            |
