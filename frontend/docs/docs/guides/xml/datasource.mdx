...
|save-settings       |page size sorting                |Сохраняемые параметры (через запятую) источника данных таблицы в локальное хранилище браузера. Срабатывает при заданном `n2o.api.widget.table.save_settings=true` |  |  |
...
#Сохраняемые параметры (через запятую) источника данных таблицы в локальное хранилище браузера. Срабатывает при заданном `n2o.api.widget.table.save_settings=true`
n2o.api.datasource.save_settings =
```
...
[JS выражение](../manual/javascript), позволяющее производить изменения целевой модели при ее отправке
...
[JS выражение](../manual/javascript), позволяющее производить изменения целевой модели при копировании в inherited-datasource
...
|field-id     |Строка                                    |Поле зависимого источника данных
