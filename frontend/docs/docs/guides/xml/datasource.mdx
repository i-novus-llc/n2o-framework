...
|source-datasource|Ссылка на [источник данных](#datasources) |Идентификатор источника данных для получения данных с родительской страницы, указывается если идентификаторы источника данных на родительской и открываемой странице отличаются |
