...
|source-datasource|Ссылка на [источник данных](#datasources) |Идентификатор источника данных из application.xml.|По умолчанию: значение `id`|
...
|source-datasource|Ссылка на [источник данных](#datasources) |Идентификатор источника данных родительской страницы.|По умолчанию: значение `id`|
