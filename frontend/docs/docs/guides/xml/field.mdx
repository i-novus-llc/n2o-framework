...
|mask                |Строка	 |Маска текста                                                           |
|mask-paste-mode     |strict free|Режим вставки значения в маску. strict - строгая проверка, значение фильтруется по маске; free - нестрогая проверка, значение вставляется как есть |strict
...
# Режим вставки значения в маску
n2o.api.control.auto_complete.mask_paste_mode=strict
```
