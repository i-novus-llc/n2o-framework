...
|icon        |[Класс иконки](https://fontawesome.com/v4.7/icons/)|Иконка статуса   |                     |
...
|icon            |[Класс иконки](https://fontawesome.com/v4.7/icons/)|Иконка по умолчанию в области загрузки                                                                                                                                                                                      |                       |
...
|Наименование|Тип             |Описание                               |Значение по умолчанию|
|------------|----------------|---------------------------------------|---------------------|
|icon        |[Класс иконки](https://fontawesome.com/v4.7/icons/)|Иконка                    |
...
**Тело**<br/>
&lt;enabling&gt; - [Условие доступности](#enabling)<br/>
&lt;fetch&gt; - [Обновление модели компонента при изменении зависимых полей](#fetch)<br/>
&lt;fetch-value&gt; - [Обновление модели поля ввода](#fetch-value)<br/>
&lt;requiring&gt; - [Условие обязательности заполнения](#requiring)<br/>
&lt;reset&gt; - [Сброс значения](#reset)<br/>
&lt;set-value&gt; - [Условие установки значений](#set-value)<br/>
&lt;visibility&gt; - [Условие видимости](#visibility)
