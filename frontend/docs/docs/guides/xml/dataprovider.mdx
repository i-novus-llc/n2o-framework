...
| forwarded-headers | Строка | Заголовки, которые должны быть скопированы из запроса клиента(через запятую) |                       |
| forwarded-cookies | Строка | Cookie, которые должны быть скопированы из запроса клиента(через запятую)    |                       |
