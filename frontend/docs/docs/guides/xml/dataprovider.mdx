...
|filter-prefix    |Строка   |Префикс для фильтров                   |                     |
|filter-suffix    |Строка   |Суффикс для фильтров                   |                     |
|sorting-separator|Строка   |Разделитель сортировок                 | ,                   |
|sorting-prefix   |Строка   |Префикс для сортировок                 |                     |
|sorting-suffix   |Строка   |Суффикс для сортировок                 |                     |
