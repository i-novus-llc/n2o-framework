...
|icon                |[Класс иконки](https://fontawesome.com/v6/icons/)|Иконка виджета                                                  |                                                                                       |
...
|icon        |[Класс иконки](https://fontawesome.com/v6/icons/)|Иконка действия                        |Вычисляется, если `id` действия из списка стандартных действий.|
