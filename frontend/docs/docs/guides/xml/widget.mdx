...
|Наименование|Тип                                                        |Описание                                    |Значение по умолчанию |
|------------|-----------------------------------------------------------|--------------------------------------------|----------------------|
|datasource  |Ссылка на [источник данных](../xml/datasource#datasources) |Источник данных вычисления условия видимости|Идентификатор источника данных для виджета
|model       |resolve edit filter multi datasource                       |Модель источника данных, из которой будет взято значение для вычисления условия видимости       |filter|
...
<column text-field-id="name">
    <dependencies>
        <visibility datasource="ds" model="resolve">type.id == 1</visibility>
