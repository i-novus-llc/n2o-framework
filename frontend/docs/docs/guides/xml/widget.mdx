...
|model       |resolve edit filter multi datasource                       |Модель для вычисления условия        |resolve                            |
...
|datasource          |Ссылка на [источник данных](../xml/datasource#datasources)                 |Идентификатор источника данных, над которым будет выполнена операция                          |Источник данных текущего виджета    |
|model               |resolve edit filter multi datasource                                       |Модель, над которой выполнится действие. Если модель пустая, то пункт меню будет заблокирован.|resolve                             |
...
|label            |Строка                                   |Наименование заголовка столбца                    |Из наименования поля выборки `id`                           |
