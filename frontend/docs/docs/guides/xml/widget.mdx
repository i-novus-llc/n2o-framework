...
|datasource             |Сссылка на [источник данных](../xml/page#datasource)  |Идентификатор источника данных для виджета                   |                                                                                       |
...
|model       |resolve filter edit multi datasource     |Модель, над которой выполнится действие                  |resolve                                                                                                         |
...
|disable-on-empty-model|true false auto                                                                      |Недоступность кнопки при пустой модели.<br/>true - кнопка недоступна при пустом контексте<br/>false - кнопка доступна при пустом контексте<br/>auto - Кнопка недоступна только при пустой модели resolve, для всех остальных моделей доступна всегда|                       |
|validate              |true false                                                                           |Валидировать ли форму при нажатии на кнопку                                                |Для каждого действия свои умолчания.             |
|validate-datasources  |Список идентификаторов [источников данных](../xml/page#datasource)                   |Источники данных, которые будут валидироваться                                             |Идентификатор источника данных текущего виджета  |
|action-id             |Ссылка на [действие страницы](..xml/page#actions) или [виджета](..xml/widget#actions)|Ссылка на действие, которое будет вызвано при нажатии на кнопку                            |                                                 |
...
[Обработчик действия](../xml/action)<br/>
[Условия доступности и видимости кнопки](#btn_dependencies)
...
###### Условия на кнопках {#btn_dependencies}
...
|Наименование|Тип                                                                        |Описание             |Значение по умолчанию              |
|------------|-----------------------------------------------------------|-------------------------------------|-----------------------------------|
|datasource  |Идентификатор [источника данных](../xml/page#datasource)   |Источник данных вычисления условия   |Источник данных текущего виджета   |
|model       |resolve filter edit multi datasource                       |Модель для вычисления условия        |resolve                            |
...
**Пример**
```xml
<enabling datasource="ds2" model="filter">type==1</enabling>
```
...
**Пример**
```xml
<visibility datasource="ds2" model="filter">type==1</visibility>
```
...
|validate              |true false                                                                           |Валидировать ли форму при нажатии на кнопку                                                   |Для каждого действия свои умолчания |
|validate-datasources  |Список идентификаторов [источников данных](../xml/page#datasource)                   |Источники данных, которые будут валидироваться                                                |Идентификатор источника данных текущего виджета|
|action-id             |Ссылка на [действие страницы](..xml/page#actions) или [виджета](..xml/widget#actions)|Ссылка на действие, которое будет вызвано при нажатии на пункт меню                           |                                    |
...
[Ячейка](../xml/cell) и [зависимости столбца](../xml/widget#dependencies)
...
[Условие видимости](../xml/widget#visibility)
...
встроенный [источник данных](../xml/page#datasource)
