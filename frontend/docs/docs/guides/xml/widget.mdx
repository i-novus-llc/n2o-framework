...
|validate-datasources|Список ссылок на [источники данных](../xml/datasource#datasources)         |Источники данных, которые будут валидироваться                                             |Идентификатор источника данных текущего виджета  |
...
|Наименование|Тип                                                                        |Описание             |Значение по умолчанию              |
|------------|-----------------------------------------------------------|-------------------------------------|-----------------------------------|
|datasource  |Ссылка на [источник данных](../xml/datasource#datasources) |Источник данных вычисления условия   |Источник данных текущего виджета   |
...
[встроенный источник данных](../xml/datasource#datasource)
