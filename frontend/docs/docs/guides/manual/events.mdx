...
<Sandbox height={300} projectId="versions_7.23_data_change_events"/>
...
<application xmlns="http://n2oapp.net/framework/config/schema/application-3.0">
    <events>
        ...
        <stomp-event id="notif" destination="/notifications">
            ...
            <alert title="Привет, Мир!" text="Текст сообщения" place="top-right" color="success" timeout="3000"/>
        </stomp-event>
    </events>
...
<application xmlns="http://n2oapp.net/framework/config/schema/application-3.0">
    <events>
        ...
        <stomp-event id="notif" destination="/notifications">
            ...
            <alert title="{header}" text="{body}" place="{place}" color="{severity}" timeout="7000"/>
        </stomp-event>
    </events>
