...
<page>
  ...
  <toolbar>
    <button label="Btn1">
        <show-modal page-id="modal">
            <datasources>
                <parent-datasource id="parentDS" source-datasource="docs1"/> <!-- ссылается на данные из docs1 -->
            </datasources>
        </show-modal>
    </button>
    <button label="Btn1">
        <show-modal page-id="modal">
            <datasources>
                <parent-datasource id="parentDS" source-datasource="docs2"/> <!-- ссылается на данные из docs2 -->
            </datasources>
        </show-modal>
    </button>
  </toolbar>
