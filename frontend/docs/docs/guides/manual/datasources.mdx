...
можно воспользоваться атрибутом `source-datasource`(идентификатор источника данных для получения данных с родительской страницы,
указывается если идентификаторы источника данных на родительской и открываемой странице отличаются).
