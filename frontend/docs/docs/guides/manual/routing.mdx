...
<Sandbox height={200} projectId="interactions_routing_routingnav" showHeader/>
...
<Sandbox height={200} projectId="interactions_routing_homepage" showHeader/>
...
<Sandbox height={200} projectId="interactions_routing_childpage" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_pathparam" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_queryparam" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_pageparam" showHeader/>
...
<Sandbox height={350} projectId="interactions_routing_queryroute" showHeader/>
...
<Sandbox height={400} projectId="interactions_routing_queryfilter" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_operation" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_operationpath" showHeader/>
...
<Sandbox height={500} projectId="interactions_routing_operationbody" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_field" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_fieldlist" showHeader/>
...
<Sandbox height={420} projectId="interactions_routing_fieldinterval" showHeader/>
...
5. При одновременном старте нескольких экземпляров приложения, работающих с общей таблицей, конкурентная регистрация маршрутов может приводить к взаимным блокировкам (deadlock).
Сохранение маршрута повторяется при возникновении таких ошибок. Количество попыток задаётся настройкой `n2o.config.register.jdbc.retry-count` (по умолчанию `5`),
а начальная задержка между попытками в миллисекундах — настройкой `n2o.config.register.jdbc.retry-delay-ms` (по умолчанию `100`).
...
4. Для изменения ключа, по которому будут сохраняться пути, необходимо задать настройку `n2o.config.register.redis.key=routes`.
