...
```
<Sandbox height={380} projectId="documentation_dynamic_icon" showHeader />
...
```
<Sandbox height={380} projectId="documentation_dynamic_textlabel" showHeader />
...
```
<Sandbox height={380} projectId="documentation_dynamic_checkboxenabled" showHeader />
...
```xml title="Форматирование значений"
<fields>
    <alert id="success" text="Привет, {name}!" color="success"/>
    <input-text id="name" default-value="Мир"/>
</fields>
```
<Sandbox height={380} projectId="documentation_dynamic_columnformat" showHeader />
...
```
<Sandbox height={380} projectId="documentation_dynamic_columnswitch" showHeader />
...
```
<Sandbox height={380} projectId="documentation_dynamic_pagelink" showHeader />
