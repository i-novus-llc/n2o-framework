...
```
<Sandbox height={380} projectId="interactions_dynamic_icon" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dynamic_textlabel" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dynamic_checkboxenabled" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dynamic_columnformat" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dynamic_columnswitch" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dynamic_pagelink" showHeader />
