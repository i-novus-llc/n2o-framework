...
Для добавление префикса и суффикса в фильтр используются атрибуты `filter-prefix` и `filter-suffix` или глобальная настройка
`n2o.engine.graphql.filter-prefix` и `n2o.engine.graphql.filter-suffix`.

Для добавление префикса и суффикса в сортировку используются атрибуты `sorting-prefix` и `sorting-suffix` или глобальная настройка
`n2o.engine.graphql.sorting-prefix` и `n2o.engine.graphql.sorting-suffix`.
