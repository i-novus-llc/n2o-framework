...
либо через имя аргумента, если он указан, например, `['name']`
...
```xml title="Маппинг примитивов в java провайдере по индексам аргументов"
<operation>
  <invocation>
...
Альтернативный способ задания маппинга:

```xml title="Маппинг примитивов в java провайдере по именам аргументов"
<operation>
  <invocation>
    <java class="com.example.Calculator" method="sum">
      <arguments>
