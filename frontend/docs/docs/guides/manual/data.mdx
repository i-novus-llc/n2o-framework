...
В выражениях нормализации могут быть использованы статические java-функции
...
ссылкой вида `normalize="#myFunction(#this)"`. Чтобы добавить функцию в контекст необходимо сделать её открытой
