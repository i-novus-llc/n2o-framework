...
<field id="name" sorting="true" sorting-expression="name :direction" sorting-mapping="['direction']"/>
```
...
:::note
По умолчанию `filter-id` эквивалентен `field-id`.
:::
...
<query xmlns="http://n2oapp.net/framework/config/schema/query-5.0">
    <filters>
        <eq field-id="code">...</eq>
        <more field-id="person.birthday">...</more>
    </filters>
...
<query>
  ...
  <fields>
    <field id="name" select-expression="name"
           sorting="true" sorting-expression="name :direction"/>
  </fields>
</query>
```
...
<query>
  ...
  <fields>
    <field id="name"
           sorting="true" sorting-expression="sort=name:{direction}"/>
  </fields>
</query>
```
...
<query>
  ...
  <fields>
    <field id="id" sorting="true" sorting-expression="{ name: $$nameDir }" sorting-mapping="['nameDir']"/>
...
<query>
    ...
    <fields>
        ...
        <field id="name" select-expression="name" domain="string"
               sorting="true" sorting-mapping="['sortName']" sorting-expression="name :sortName"/>
...
<field id="name" select-expression="name" domain="string"
       sorting="true" sorting-expression="name :nameDirection"/>
...
<query>
  ...
  <fields>
      ...
      <field id="userAge" domain="integer"
             sorting="true" sorting-mapping="['sortUserAge']"
