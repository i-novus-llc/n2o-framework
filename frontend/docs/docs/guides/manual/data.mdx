...
#### Настройки SQL провайдера {#sql_settings}
...
#### Настройки GraphQl провайдера {#graphql_settings}
...
### Функции нормализации {#normalize_functions}
...
|Имя метода               |Описание                                 |Пример вызова                    |
|-------------------------|-----------------------------------------|---------------------------------|
|`jsonToMap`              |Преобразование строки json в объект      |#jsonToMap(#this)                |
|`mapToJson`              |Преобразование объекта в строку json     |#mapToJson(#this)                |
|`encodeToBase64`         |Преобразование строки из UTF-16 в base64 |#encodeToBase64(#this)           |
|`decodeFromBase64`       |Преобразование строки из base64 в UTF-16 |#decodeFromBase64(#this)         |
|`formatByMask`           |Форматирование значения по маске         |#formatByMask(#this, "##-## ##") |
|`formatFullName`         |Форматирование ФИО без сокращений        |#formatFullName(#this)           |
|`formatNameWithInitials` |Форматирование ФИО с инициалами          |#formatNameWithInitials(#this)   |
