...
Например, паттерн `/person/*/profile` отобразит боковую панель на страницах пути которых соответствуют шаблону, например, `/person/1/profile` или `/person/32/profile`, но никак не по пути `/person/4/profile/img`.
