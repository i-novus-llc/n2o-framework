...
и в названии страницы разрешаются на клиенте с помощью [источника данных](../xml/page#datasources) страницы.
...
|&lt;show-modal&gt;  |n2o/overlays/INSERT_MODAL  |[Открытие модального окна](../xml/action#show-modal)                                |
...
|&lt;close&gt;       |n2o/overlays/CLOSE         |[Закрытие модального окна или возврат на предыдущую страницу](../xml/action#close)  |
|&lt;refresh&gt;     |n2o/datasource/DATA_REQUEST|[Обновление данных виджета](../xml/action#refresh)                                  |
|&lt;clear&gt;       |n2o/models/CLEAR           |[Очистка данных виджета](../xml/action#clear)                                       |
|&lt;copy&gt;        |n2o/models/COPY            |[Копирование данных виджета из одной модели в другую](../xml/action#copy)           |
