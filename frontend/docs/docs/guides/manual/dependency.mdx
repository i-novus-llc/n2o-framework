...
```
<Sandbox height={450} projectId="documentation_dependency_enabledcell" showHeader />
...
```
<Sandbox height={420} projectId="documentation_dependency_visibilitycell" showHeader />
