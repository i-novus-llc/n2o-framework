...
Зависимоcти задаются [выражениями на языке JavaScript](./javascript).
...
```
<Sandbox height={380} projectId="interactions_dependency_enabling" showHeader />
...
но его можно задать через [javaScript выражение](./javascript):
...
<input-text id="maidenName"
    ...
    <!-- Поле "Девичья фамилия" доступно для редактирования, если пол женский, где
         gender - это поле в источнике данных виджета с текущей моделью данных -->
```
<Sandbox height={380} projectId="interactions_dependency_enabledshort" showHeader />
...
```
<Sandbox height={420} projectId="interactions_dependency_enabledset" showHeader />
...
```
<Sandbox height={330} projectId="interactions_dependency_enablingbutton" showHeader />
...
```
<Sandbox height={330} projectId="interactions_dependency_enabledbutton" showHeader />
...
```
<Sandbox height={450} projectId="interactions_dependency_enabledcell" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dependency_visibility" showHeader />
...
<input-text id="maidenName"
    ...
    <!-- Поле "Девичья фамилия" видимо, если пол женский -->
```
<Sandbox height={380} projectId="interactions_dependency_visible" showHeader />
...
```
<Sandbox height={420} projectId="interactions_dependency_visibleset" showHeader />
...
```
<Sandbox height={350} projectId="interactions_dependency_visibilitybutton" showHeader />
...
```
<Sandbox height={350} projectId="interactions_dependency_visiblebutton" showHeader />
...
```
<Sandbox height={520} projectId="interactions_dependency_visibilitycolumn" showHeader />
...
```
<Sandbox height={420} projectId="interactions_dependency_visibilitycell" showHeader />


### Установка значений

С помощью установки значений можно автоматически заполнять поля ввода по [JavaScript выражениям](./javascript).
...
```
<Sandbox height={450} projectId="interactions_dependency_setvalue" showHeader />

В теле `<set-value>` должно быть записано [выражение на языке JavaScript](./javascript), которое вернёт новое значение поля.
...
```
<Sandbox height={400} projectId="interactions_dependency_setvaluelist" showHeader />
...
<checkbox label="Адрес проживания совпадает с регистрацией">
    <dependencies>
        ...
        <set-value on="addressReq, addressFact">
              addressReq == addressFact
        </set-value>
    </dependencies>
</checkbox>
```
<Sandbox height={450} projectId="interactions_dependency_setvaluecheckbox" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dependency_requiring" showHeader />
...
```
<Sandbox height={380} projectId="interactions_dependency_required" showHeader />
