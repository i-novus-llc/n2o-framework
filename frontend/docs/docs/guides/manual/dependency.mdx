...
```
<Sandbox height={200} projectId="documentation_dependency_enabling" showHeader />
...
<input-text id="maidenName"
    ...
    <!-- Поле "Девичья фамилия" доступно для редактирования, если пол женский, где
         gender - это поле в источнике данных виджета с текущей моделью данных -->
```
<Sandbox height={200} projectId="documentation_dependency_enabledshort" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_enabledset" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_enablingbutton" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_enabledbutton" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_enabledcell" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visibility" showHeader />
...
<input-text id="maidenName"
    ...
    <!-- Поле "Девичья фамилия" видимо, если пол женский -->
```
<Sandbox height={200} projectId="documentation_dependency_visible" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visibleset" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visibilitybutton" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visiblebutton" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visibilitycolumn" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_visibilitycell" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_setvalue" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_setvaluelist" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_setvaluecheckbox" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_requiring" showHeader />
...
```
<Sandbox height={200} projectId="documentation_dependency_required" showHeader />
