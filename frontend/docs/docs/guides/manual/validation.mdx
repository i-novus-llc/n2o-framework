...
```
<Sandbox height={300} projectId="interactions_validation_condition" showHeader />
...
```
<Sandbox height={350} projectId="interactions_validation_constraint" showHeader />
...
```
<Sandbox height={400} projectId="interactions_validation_required" showHeader />
...
```
<Sandbox height={400} projectId="interactions_validation_mandatory" showHeader />
...
```
<Sandbox height={450} projectId="interactions_validation_mandatoryenabled" showHeader />
...
```
<Sandbox height={450} projectId="interactions_validation_dialog" showHeader />
...
```
<Sandbox height={300} projectId="interactions_validation_whitelist" showHeader />
