...
import {DateTimeControl as DatePicker} from '../../../inputs/DatePicker/DateTimeControl'
import {PopUp} from '../../../inputs/DatePicker/PopUp'
import {Calendar} from '../../../inputs/DatePicker/Calendar'
import { CalendarType } from '../../../inputs/DatePicker/types'
...
describe('<Calendar />', () => {
    ...
    it('при нажатии на название месяца вид календаря - по месяцам', () => {
        ...
        wrapper.find('.n2o-calendar-header-month-title').simulate('click')
        wrapper.update()
        expect(wrapper.state('calendarType')).toBe(CalendarType.BY_MONTHS)
    })
    ...
    it('при нажатии на год вид календаря - по годам', () => {
        ...
        wrapper.find('.n2o-calendar-header-year-title').simulate('click')
        wrapper.update()
        expect(wrapper.state('calendarType')).toBe(CalendarType.BY_YEARS)
    })
