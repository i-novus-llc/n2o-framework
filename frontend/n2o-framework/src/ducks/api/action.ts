...
export const sagas = [
    takeEvery(conditionCreator.type, AsyncEffectWrapper(conditionEffect)),
    takeEvery(switchCreator.type, AsyncEffectWrapper(switchEffect)),
    takeEvery(sequenceCreator.type, AsyncEffectWrapper(sequenceEffect)),
]
