...
const withMetadata = Component => {
  ...
  const mapStateToProps = createStructuredSelector({
    metadata: (state, props) =>
      makePageMetadataByIdSelector(props.pageId)(state, props),
    loading: (state, props) =>
      makePageLoadingByIdSelector(props.pageId)(state, props),
  ...
  function mapDispatchToProps(dispatch) {
    return {
      ...
      reset: pageId => dispatch(resetPage(pageId)) && dispatch(destroyModal()),
