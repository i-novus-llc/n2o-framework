    ...
    .add(
        ...
        () => (
            <>
                ...
                <h1>Transform:</h1>
                <code>{'{code:true}'}</code>
                <Title text={meta.text} level={3} code />
                <code>{'{del:true}'}</code>
                <Title text={meta.text} level={3} del />
                <code>{'{mark:true}'}</code>
                <Title text={meta.text} level={3} mark />
                <code>{'{strong:true}'}</code>
                <Title text={meta.text} level={3} strong />
                <code>{'{underline:true}'}</code>
                <Title text={meta.text} level={3} underline />
                <code>{'{small:true}'}</code>
                <Title text={meta.text} level={3} small />
                <br />
                <h1>Colors:</h1>
                {map(allColors, color => (
