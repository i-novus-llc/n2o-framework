    ...
    .add(
        ...
        () => (
            <>
                ...
                <h1>Transform:</h1>
                <code>{'{code:true}'}</code>
                <Paragraph text={txt} code />
                <code>{'{del:true}'}</code>
                <Paragraph text={txt} del />
                <code>{'{mark:true}'}</code>
                <Paragraph text={txt} mark />
                <code>{'{strong:true}'}</code>
                <Paragraph text={txt} strong />
                <code>{'{underline:true}'}</code>
                <Paragraph text={txt} underline />
                <code>{'{small:true}'}</code>
                <Paragraph text={txt} small />
                <code>{'{copyable:true}'}</code>
                <Paragraph text={txt} copyable />
                <code>{'{editable:true}'}</code>
                <Paragraph text={txt} editable />
                <br />
                <h1>Colors:</h1>
                {map(allColors, color => (
