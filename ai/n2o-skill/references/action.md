...
| place | left / right / top / bottom | Position | right |
...
| message-place | top / bottom / topLeft / topRight / bottomLeft / bottomRight | Message placement | top |
...
| place | top / bottom / topLeft / topRight / bottomLeft / bottomRight | Position | top |
...
| style | String | CSS style | |
```xml
<alert text="Saved!" color="success" place="topRight"/>
```
